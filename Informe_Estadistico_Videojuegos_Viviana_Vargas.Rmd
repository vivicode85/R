...
ggplot(good_summary, aes(x = Age, y = Average_Playing_Hours, color = Gender)) +
  geom_line() +
  geom_point() +
  labs(title = "Rango de horas de juego (Good)",
       x = "Edad",
...
ggplot(bad_summary, aes(x = Age, y = Average_Playing_Hours, color = Gender)) +
  geom_line() +
  geom_point() +
  labs(title = "Rango de horas de juego  (Tired)",
       x = "Edad",
       y = "Horas de Juego Promedio")
...
ggplot(bad_summary, aes(x = Age, y = Average_Playing_Hours, color = Gender)) +
  geom_line() +
  geom_point() +
  labs(title = "Rango de horas de juego (Unmotivated)",
       x = "Edad",
       y = "Horas de Juego Promedio")
...
En cuanto a la relación que tienen los videojuegos con la salud mental de personas<br> entre 11 y 28 años, en el caso femenino suelen jugar más en la adolescencia y un rango menor de hora y media, por lo que suelen<br> verse menos afectadas a nivel de cansancio y desmotivación, al contrario que el grupo masculino, comprendido en un rango <br>de edades de entre 17 y 28 años aproximadamente, quienes sí pueden llegar a notarse cansados y/o desmotivados después más<br> de una hora y media.
...
<img src="C:/Users/Pato/Downloads/U1hT.gif" alt="Bibliografía" style="width:35%;">
</div>
...
<div style="margin: 20px; text-align: center;">
  ...
  <a href="https://historia.nationalgeographic.com.es/a/cual-fue-primer-videojuego-esta-es-historia-pasatiempo-universal_20123">Historia de los Videojuegos</a><br>
   <a href="https://www.kaggle.com/datasets/gregorut/videogamesales">Dataset</a><br>
      <a href="https://www.kaggle.com/datasets/alanpal/gaming-and-mental-health">Relación entre la salud mental y los videojuegos</a><br><br><br><br>
<img src="C:/Users/Pato/Downloads/CGd.gif" alt="Bibliografía" style="width:35%;">
</div><br><br><br> <b>©2024 - Sindy Viviana Vargas Gómez</b><br>  <i><a href="https://github.com/vivicode85/R/blob/1f6f906d1fe19a37c2535cd88ddbd852e06af834/Informe_Estadistico_Videojuegos_Viviana_Vargas.Rmd">source code</a></i>                
